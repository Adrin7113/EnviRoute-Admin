      ...
      <div className="min-h-screen w-screen flex flex-col items-center gap-5 py-10">
        ...
        <div className="w-1/2 sm:w-2/3 h-32 mb-5">
          ...
          <button
            ...
            className="bg-[#BBD6B8] w-1/3 sm:w-1/2 sm:p-2 h-16 rounded-xl jose text-3xl text-[#002B5B] hover:bg-[#AEC2B6] transition-all ease-in-out duration-300"
          >
            Search
          </button>
        </div>
        {list && (
          <>
            {list.map((value, i) => (
              <div
                key={i}
                className="bg-white border-[#AEC2B6]  sm:h-[350px] rounded-xl border-4 h-[125px] w-2/3 flex justify-between items-center p-5 gap-2"
              >
                <div className="flex gap-5 sm:flex-col sm:justify-center">
                  <div className="w-32">
                  ...
                  <h1 className="text-xl jose text-[#002B5B] bg-[#BBD6B8] p-3 rounded-xl h-max sm:w-2/3">
                    {value.tags}
                  </h1>
                </div>
                {value.Taken && (
